...
int main(void)
{
	...
	Podesi_USART_Komunikaciju();
	//inicijalizuj_servo_tajmer_20ms();		//podesavanje komunikacije
	
	_delay_ms(2000);
	PORTE.OUT |= 0x01; //Za service
	sendMsg("LOGIKA",&USART_LCD);
	...
	funny_action_timer=0;
	sys_time=0;
	//postavi_sistem(0,0,180);
	//GLAVNI WHILE!!!
	while(1){
